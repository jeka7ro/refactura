...
const robotoPath = path.resolve(process.cwd(), "server/assets/fonts/Roboto-Regular.ttf");
const robotoBoldPath = path.resolve(process.cwd(), "server/assets/fonts/Roboto-Bold.ttf");
...
doc.font("Helvetica").fontSize(12).text("DRA opacă ALDRA 140x300 nisipie", 100, 100);
doc.end();
