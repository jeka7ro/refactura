          ...
          <form onSubmit={handleLogin} className="space-y-4" autoComplete="on">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button
                type="button"
                variant="outline"
                className="!rounded-full border-slate-200 text-slate-700 bg-white hover:bg-slate-50 hover:text-slate-900 shadow-sm"
                onClick={() => toast({ title: "Implementare în lucru", description: "Vă rugăm să utilizați adresa de email temporar." })}
              >
              ...
              <Button
                type="button"
                variant="outline"
                className="!rounded-full bg-slate-900 text-white hover:bg-slate-800 hover:text-white border-none shadow-sm"
                onClick={() => toast({ title: "Implementare în lucru", description: "Vă rugăm să utilizați adresa de email temporar." })}
              >
                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M16.365 1.43c0 0 1.04-.06 2.09-1.12.87-.88 1.49-2.06 1.43-3.32h-1.81c-.06 1.01-.58 2.02-1.31 2.76-.84.85-1.96 1.03-2.31 1.03v.65h1.91zM17.44 14.61c-1.04-.06-2.12-.66-2.69-.66-.58 0-1.78.63-2.95.63-1.27 0-2.45-.63-3.08-1.55-1.3-1.89-2.25-5.36-.93-7.66.65-1.13 1.83-1.84 3.12-1.84 1.25 0 2.22.57 2.8.57.57 0 1.64-.6 3.03-.6 1.15 0 2.21.46 2.94 1.26-2.15 1.28-1.84 4.09.28 5.04-.5 1.28-1.14 2.58-1.93 3.69-.6.82-1.26 1.57-2.12 1.57-.86 0-1.19-.53-2.14-.53s-1.32.53-2.14.53c-.87 0-1.54-.77-2.12-1.57z"/>
                </svg>
                Apple
              </Button>
            </div>
