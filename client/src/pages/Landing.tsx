      ...
      <footer className="py-12 bg-white border-t border-slate-100">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center gap-2">
              <img src="/favicon.png" alt="Icon" className="h-7 w-7 flex-shrink-0" />
              <div className="flex flex-col pt-1 w-fit">
                <span className="text-xl font-black leading-none text-[#1e3a8a] tracking-tight" style={{ fontFamily: 'Inter, sans-serif' }}>GetApp</span>
        ...
        <div className="hidden sm:flex w-44 bg-slate-900 border-r border-slate-800 p-3 flex-col gap-1 flex-shrink-0">
          <div className="flex items-center mb-4 cursor-pointer">
            <div className="bg-white px-3 py-2 rounded-lg shadow-sm border border-white/10 flex items-center justify-center gap-1.5">
              <img src="/favicon.png" alt="Icon" className="h-5 w-5 flex-shrink-0" />
              <div className="flex flex-col pt-0.5 w-fit">
                <span className="text-[14px] font-black leading-none text-[#1e3a8a] tracking-tight" style={{ fontFamily: 'Inter, sans-serif' }}>GetApp</span>
