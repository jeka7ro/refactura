        ...
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleRegister} className="space-y-4" autoComplete="on">
            ...
            <div>
              ...
              <div className={`flex items-center bg-white rounded-[8px] border transition-all overflow-hidden focus-within:ring-2 ${
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3.5 bg-blue-600 hover:bg-blue-700 disabled:bg-blue-400 text-white font-bold text-sm rounded-[8px] flex items-center justify-center gap-2 transition-all shadow-lg shadow-blue-500/30 mt-2"
            >
              {isLoading ? (
            ...
            <div className="grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 py-2.5 border border-slate-200 bg-white hover:bg-slate-50 rounded-[8px] font-semibold text-sm text-slate-700 transition-colors"
              ...
              <button
                type="button"
                className="w-full flex items-center justify-center gap-2 py-2.5 bg-slate-900 hover:bg-slate-800 border border-slate-900 rounded-[8px] font-semibold text-sm text-white transition-colors"
