          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-slate-100 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50">
                <th className="px-4 py-3 text-left text-xs font-bold uppercase tracking-wider text-slate-500 w-12">
                  #
                </th>
            ...
            <tfoot className="bg-slate-50 dark:bg-slate-800/50 border-t-2 border-slate-200 dark:border-slate-700">
              ...
              <tr className="bg-sky-50 dark:bg-sky-900/20">
                <td
                  colSpan={showCodes ? 5 : 4}
                  className="px-4 py-4 text-right font-black text-sky-700 dark:text-sky-400 text-base"
                >
                  TOTAL DEVIZ:
                </td>
                <td className="px-4 py-4 text-right font-black text-sky-700 dark:text-sky-400 text-base">
                  {Number(deviz.total).toFixed(2)} RON
                </td>
              </tr>
            </tfoot>
          </table>
