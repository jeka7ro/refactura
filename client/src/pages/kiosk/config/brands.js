...
export const BRANDS = {
  smashme: {
    ...
    fontWeight: 900,
    welcomeSlides: [
      { headline: "Burgeri smash", sub: "suculenți", emoji: "🍔" },
    ],
  ...
  rollmaster: {
    ...
    fontWeight: 700,
    welcomeSlides: [
      { headline: "Sushi proaspăt", sub: "autentic", emoji: "🍣" },
    ],
  ...
  lovesushi: {
    ...
    fontWeight: 700,
    welcomeSlides: [
      { headline: "We Love Sushi!", sub: "proaspăt", emoji: "🍣" },
    ],
    categoryEmojis: { rolls: "🌀", nigiri: "🍣" },
  },
  pokiwoki: {
...
export function applyBrandTheme(brandId) {
  ...
  root.setAttribute(
    "data-theme",
    colors.bgDark.startsWith("#F") ? "light" : "dark"
  );
}
