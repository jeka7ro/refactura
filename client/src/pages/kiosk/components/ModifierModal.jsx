...
export default function ModifierModal({
  ...
  return (
    <div
      className={`modifier-modal-overlay ${visible ? "visible" : ""}`}
      onClick={handleClose}
    >
      <div
        className={`modifier-modal-sheet ${visible ? "visible" : ""}`}
      ...
      >
        ...
        <div className="mm-header">
          ...
          <div className="mm-product-info">
            ...
            <span className="mm-product-price">
              {totalPrice.toFixed(2)} {t("currency", lang) || "lei"}
            </span>
          </div>
        </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="mm-opt-text">
                        ...
                        <span
                          className={`mm-opt-price ${isFree ? "mm-opt-price--free" : ""}`}
                        >
                          {isFree
                            ? t("included", lang) || "Inclus"
                            : `+${opt.price.toFixed(2)} ${t("currency", lang) || "lei"}`}
                        </span>
                      </div>
                      <div
                        className={`mm-opt-check ${isSelected ? "checked" : ""}`}
                      />
                    </button>
                  );
                })}
        ...
        <div className="mm-footer">
          ...
          >
            ...
            <span className="mm-confirm-price">
              {totalPrice.toFixed(2)} {t("currency", lang) || "lei"}
            </span>
          </button>
        </div>
