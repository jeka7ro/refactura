      ...
      <div className="confirm-content">
        ...
        {wonPrize && (
          ...
          >
            ...
            >
              Arată acest ecran cu numărul #{orderNum} The casierie pentru
              validare.
            </p>
          </div>
        )}
        ...
        <div className="confirm-summary">
          <div className="cs-row">
            <span>
              {cartItems.length}{" "}
              {cartItems.length > 1
                ? t("products_count_many", lang)
                : t("products_count", lang)}
            </span>
        ...
        <div className="confirm-countdown">
          <div
            ...
            style={{ "--pct": `${(countdown / 15) * 100}%` }}
          />
          <p>
            {t("screen_reset_in", lang)} <strong>{countdown}s</strong>
          </p>
        </div>
