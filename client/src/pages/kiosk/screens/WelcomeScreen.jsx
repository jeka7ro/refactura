...
export default function WelcomeScreen() {
  ...
  const FLAG_GRADIENTS = {
    ...
    en: 'center/cover no-repeat url("https://flagcdn.com/w320/gb.png")',
  ...
  const btnColor = useFlagBg
    ? FLAG_GRADIENTS[lang] || baseBtnColor
    : baseBtnColor;
  ...
  return (
    <div
      className={`welcome-screen ${isUnlocking ? "unlocking" : ""}`}
    ...
    >
      ...
      {showLangOnWelcome && allowedLangs.length > 1 && (
        <div
          ...
          style={
            locationData?.langVerticalPosition === "top"
      ...
      {posterVisible && poster && (
        ...
        >
          {poster.type === "video" ? (
            ...
            <iframe src={poster.url} className="poster-iframe" title="Promo" />
          ) : (
            <img
              src={poster.url}
              alt="Promo"
          ...
          <div className="poster-cta-center">
              ...
              {(locationData?.brands?.length > 1
                ...
                (poster.showLogo && (
                  <div className="brand-logo-wrapper">
                    <img
                      src={brand.logoImg || "/brands/smashme-logo.png"}
                      alt=""
                      className="brand-logo-img"
                    />
                  </div>
            ...
            <button
              ...
              style={{
                ...
                borderWidth: btnBorderColor !== "transparent" ? "3px" : "0",
                borderStyle: "solid",
                boxShadow: `0 12px 32px ${btnShadowColor}80`,
              }}
              onClick={e => {
                e.stopPropagation();
                handlePosterTap();
      ...
      <div className="welcome-promo-wrap">
        {slides.map((s, i) => (
          <div
            key={i}
            className={`welcome-promo ${i === slide ? "promo--active" : ""}`}
          >
            {s.heroImage ? (
              <img
                src={s.heroImage}
      ...
      <div className="welcome-cta">
        ...
        >
          ...
          <span style={{ color: btnTextColor }}>
            {customBtnText || t("tap_to_order", lang)}
          </span>
        </button>
      </div>
    </div>
