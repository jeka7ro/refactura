    ...
    <div className="product-screen">
      ...
      <div className="ps-left">
        ...
        <div className="ps-left-content scroll-y">
          <div
            ...
            style={
              imgError || !product.image ? { background: "var(--surface)" } : {}
            }
          >
          ...
          <div className="pd-hero-info">
            ...
            {product.energyAmount && (
              <span className="pd-calories">
                🔥 {Math.round(product.energyAmount)} kcal
              </span>
            )}
          ...
          {modifiers.map(mod => {
            ...
            const groupLabel = mod.name
              ? mod.name.toUpperCase()
              : t("options", lang).toUpperCase();
            ...
            return (
              <div key={mod.id} className="pd-modifier">
                <div className="pd-mod-header">
                  <h3>{groupLabel}</h3>
                  {reqBadge && <span className="req-badge">{reqBadge}</span>}
                </div>
        ...
        <div className="pd-footer">
          ...
          >
            ...
            <span className="pd-total">
              {totalPrice.toFixed(2)} {t("lei", lang)}
            </span>
          </button>
        </div>
      </div>
      ...
      <div className="ps-right scroll-y">
        ...
        >
          ...
          <p style={{ fontSize: "1.2rem", color: "#4b5563", margin: 0 }}>
            Ce s-ar mai potrivi cu comanda ta de astăzi?
          </p>
        </div>
        ...
        {suggestions.length > 0 ? (
          ...
          <div style={{ textAlign: "center", padding: "60px 0", opacity: 0.5 }}>
            ...
            <h3 style={{ color: "#111827", fontSize: "1.4rem" }}>
              Fără recomandări momentan.
            </h3>
          </div>
        )}
      </div>
